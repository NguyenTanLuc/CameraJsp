                    ...
                    <div class="modal-body">
                      <form>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="ttsp">
                        </div>
                        <div class="form-group">
                          <label>Loại sản phẩm</label>
                          <input type="text" class="form-control" id="tlsp">
                        </div>
                        <div class="form-group">
                          <label>Thuộc danh mục</label>
                          <select id="ttdm" class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="tgsp">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="ckeditor" id="tchitiet" cols="80" rows="10" style="background:#999"></textarea>
                        </div>
                      </form>
                  ...
                  <div class="box">
                    <div class="box-header">
                      ...
                      <div class="text-right">
                        <button class="btn btn-info" data-toggle="modal" data-target="#add"><span class="glyphicon glyphicon-plus"></span>
                          Thêm</button>
                      </div>
