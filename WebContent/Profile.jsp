...
<body>
								...
								<table cellspacing="0" cellpadding="0">
									<tbody>
										...
										<tr>
											...
											<td><span class="font_err">Điền mật khẩu mới để
													thay đổi mật khẩu (Nếu để trống sẽ giữ lại mật khẩu cũ) </span></td>
										</tr>
										<tr>
											<td>Mật khẩu<span class="required">*</span></td>
											<td><input class="form-control" type="password"
												style="width: 300px;" name="password"></td>
										</tr>
										<tr>
											<td>Xác nhận mật khẩu <span class="required">*</span></td>
											<td><input class="form-control" type="password"
												style="width: 300px;" name="re_password"></td>
										</tr>
										<tr>
											<td>Họ tên <span class="required">*</span>
											</td>
											<td><input class="form-control" type="text"
												value="<%=user.getName()%>" style="width: 300px;"></td>
										</tr>
										<tr>
											<td>Điện thoại <span class="required">*</span>
											</td>
											<td><input class="form-control" type="text"
												value="<%=user.getPhone()%>" style="width: 300px;">
											</td>
										</tr>
										<tr>
											<td>Địa chỉ</td>
											<td><input class="form-control" type="text" id="address"
												value="<%=user.getAddress()%>" style="width: 300px;"></td>
										</tr>
										<tr>
											<td>Thành phố</td>
											<td><select class="form-control" name="city" id="city"
												style="width: 302px;" onchange="CityChange(this.value);">
										...
										<tr>
											...
											<td class="last">
												<button class="btn btn-danger" type="submit"
													class="btn_member btn-danger" value="Cập nhật">
													<span>Cập nhật</span>
												</button>&nbsp;&nbsp;
												<button class="btn btn-danger" type="reset"
													class="btn_member btn-danger" value="Nhập lại">
													<span>Nhập lại</span>
												</button>
											</td>
										</tr>
			...
			<div class="col-md-3 hidden-xs hidden-sm">
				...
				<div class="media news longer">
					<div class="media-left">
						<a href="profile.html"> <img alt="Thông tin cá nhân"
							src="./public/images/ui_images/profile.png"> Thông tin cá
							nhân
						</a>
					</div>
				</div>
				<div class="media news longer">
					<span class="media-left"> <img alt="​Đơn hàng"
						src="./public/images/ui_images/shopping-cart.png"> <a
						href="danhsachdonhang.html">Quản lý đơn hàng</a>​ 
				</div>
				</span>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-md-5">
						<div class="diaChiText">
							...
							<p>
								<span style="color: #FF8C00;">Giới thiệu dịch vụ </span><a
									href="https://sites.google.com/site/camerafptvietnam/"><span
									style="color: #FF8C00;">lắp đặt camera</span></a><span
	...
	<%
			...
			response.getWriter()
					.println("<script> alert('Bạn chưa đăng nhập');window.location = 'index.jsp' ;</script>");
		}
	%>
</body>
</html>